...
class QuestionTest {
    ...
    public void testConstructorWithoutId() {
        Question q = new Question(101, QuestionType.fill_in_the_blank, "Univercity name is ___", "Freeuni");
    ...
    public void testToString() {
        Question q = new Question(7, 303, QuestionType.picture_response_questions, "What's shown in the image?", "A dog");
        ...
        assertTrue(output.contains("answer='A dog'"));
    }
